...
enum Shape {ROCK, PAPER, SCISSORS}; // constants representing possible shapes
...
enum GameStatus gameStatus = CONTINUE; // may be CONTINUE, GAME_WON, or
// GAME_LOST
...
enum Shape playerShape = convertIntToShape(playerShapeInt); // player
// shape
enum Shape computerShape = computerPlayRandomShape(); // computer plays
// random shape
...
enum RoundStatus getRoundStatus(enum Shape playerShape, enum Shape
computerShape) {
